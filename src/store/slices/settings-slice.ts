...
export const selectSettingsTheme = (state: AppState) => state.settings.theme
export const selectSettingsPomodoroTimer = (state: AppState) => state.settings.pomodoroTimer
